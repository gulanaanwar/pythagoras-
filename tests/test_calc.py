...
def test_square():
    ...
    # Act
    output_1, output_2 = triangle.calc.square(expected_output_1, expected_output_2)
...
def test_hypotenuse():
    ...
    test_opp_sq = 1
    test_adj_sq = 1
    test_hypot = 1.4142135623730951
    
    #Act
    hypot_output = triangle.calc.hypotenuse(test_opp_sq, test_adj_sq)
